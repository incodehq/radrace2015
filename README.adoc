...
In retrospect it was a mistake to bother creating the `ShoppingBasket` as a wrapper around the `Order`; one of those "seemed a good idea at the time" sort of things.
