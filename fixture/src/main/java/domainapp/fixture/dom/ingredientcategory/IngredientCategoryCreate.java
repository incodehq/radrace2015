...
package domainapp.fixture.dom.ingredientcategory;
...
public class IngredientCategoryCreate extends FixtureScript {
    ...
    public IngredientCategoryCreate setName(final String name) {
        this.name = name;
        return this;
    }
    //endregion
