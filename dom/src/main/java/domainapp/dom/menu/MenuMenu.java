...
public class MenuMenu {
    ...
    public static class CreateDomainEvent extends ActionDomainEvent<MenuMenu> {
        public CreateDomainEvent(final MenuMenu source, final Identifier identifier, final Object... arguments) {
