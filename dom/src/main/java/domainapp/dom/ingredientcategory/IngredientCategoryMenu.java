...
public class IngredientCategoryMenu {
    ...
    public static class CreateDomainEvent extends ActionDomainEvent<IngredientCategoryMenu> {
        public CreateDomainEvent(final IngredientCategoryMenu source, final Identifier identifier, final Object... arguments) {
    ...
    public IngredientCategory create(
            @ParameterLayout(named="Name")
            final String name) {
        return ingredientCategoryRepository.create(name);
    }
