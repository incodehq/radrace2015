...
public class IngredientCategory implements Comparable<IngredientCategory> {
    ...
    public static class UpdateNameDomainEvent extends ActionDomainEvent<IngredientCategory> {
        public UpdateNameDomainEvent(final IngredientCategory source, final Identifier identifier, final Object... arguments) {
